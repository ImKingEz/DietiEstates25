package dietiestates25ui.handler;

import dietiestates25ui.MainApplication;
import dietiestates25ui.controller.AbstractController;
import dietiestates25ui.controller.AccountCompletionController;
...
public class OAuth2Handler {
    ...
    public OAuth2Handler(AbstractController controller) {
    ...
    private void handleOAuthSuccess(String url) {
        String token = parseTokenFromURL(url);
        if (isValidToken(token)) {
            controller.openDashboard(token);
        }
    }
